  ...
  $.getJSON(
    ...
    function(data) {
      $.each(data, function(key, item) {
        var elemento = "<div class='sold-itens__card' id='sold-itens__card" + key + "'>";
        ...
        if(item.productInstallmentsValue > 0) {
          ...
          share = share.substring(0, share.length - 2) + "," + share.substring(share.length - 2);
        }

        elemento += "<h3><b>por R$ " + price + "</b></h3>";

        if(share) {
          elemento += "<span>ou por " +
